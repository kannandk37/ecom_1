...
// const IdentityForm: React.FC<IdentityFormProps> = ({ user, onLoginClick }) => {
//   return (
//     <div className="identity-container">
//       <div className="section-header">
//         <span className="step-tag">Step 01</span>
//         <h2 className="section-title">Customer Identity</h2>
//         <p className="section-subtitle">
//           Please verify your account details for this order.
//         </p>
//       </div>
//       {/* {user ? ( */}
//       /* LOGGED IN STATE */
...
//         </div>
//         <button className="change-account-btn" onClick={onLoginClick}>
//           Switch Account
//         </button>
//       </div>
//       {/* ) : ( */}
//       /* GUEST / LOGIN STATE */ //{" "}
//       {/* <div className="identity-guest-flow">
//         //{" "}
...
//             // <input type="email" placeholder="curator@dryfruit.co" />
//             //{" "}
//           </div>
//           //{" "}
//           <p className="helper-text">
//             // We'll use this to send your order confirmation and tracking.
//             //{" "}
//           </p>
//           //{" "}
//         </div>
...
//             //{" "}
//             <p>Sign in to use your saved addresses and earn reward points.</p>
//             //{" "}
//           </div>
//           //{" "}
//           <button className="inline-login-btn" onClick={onLoginClick}>
...
//         <p>🍃 By continuing, you agree to Nature's Candy terms of service.</p>
//       </div>
//     </div>
//   );
// };
